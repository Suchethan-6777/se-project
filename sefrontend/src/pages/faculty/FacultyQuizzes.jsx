    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading assigned quizzes...</p>
        </div>
      </div>
    );
  }
  ...
  <div className="card">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">View quizzes assigned to you by other faculty or administrators</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredQuizzes.length === 0 ? (
          <div className="col-span-full bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">No assigned quizzes found</h3>
          ...
          filteredQuizzes.map((quiz) => {
            const status = getQuizStatus(quiz);
            return (
              <div key={quiz.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition duration-150 ease-in-out">
                <div className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-gray-900">{quiz.createdBy?.name || 'Unknown'}</span>
                    </div>
                    <div className="flex justify-between text-sm">
